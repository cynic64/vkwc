...
COMMAND="gcc -Wall -pedantic -ggdb -o vkwc vkwc.c render.c wlroots/render/vulkan/*.c wlroots/render/pixel_format.c wlroots/build/protocol/*.c wlroots/types/wlr_screencopy_v1.c wlroots/util/*.c wlroots/types/wlr_surface.c $LIBS -DWLR_USE_UNSTABLE -I. -Iwlroots/include -Iwlroots/build -I wlroots/build/protocol"
